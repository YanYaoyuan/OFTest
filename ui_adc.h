...
public:
    ...
    void setupUi(QWidget *adc)
    {
        ...
        adc_refresh->setGeometry(QRect(4, 30, 91, 24));
        ...
        loadLocaldata = new QPushButton(adc);
        loadLocaldata->setObjectName(QString::fromUtf8("loadLocaldata"));
        loadLocaldata->setGeometry(QRect(110, 30, 101, 23));
    ...
    void retranslateUi(QWidget *adc)
    {
        ...
        loadLocaldata->setText(QCoreApplication::translate("adc", "Load Localdata", nullptr));
    } // retranslateUi
